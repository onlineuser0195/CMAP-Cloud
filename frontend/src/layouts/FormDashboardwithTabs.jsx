...
const FormDashboard = () => {
  ...
  const columns = [
    ...
    {
      field: 'visitorId',
      headerName: 'Visitor(s) Request ID',
      width: 150,
    ...
    },
    {
      ...
      renderCell: params => {
        ...
        //   return (
        //     <Chip label={label} color={statusColors[params.row.approved] || 'info'} size="small"/>
        //   );
        // }
      },
    },
  ...
  return (
    <div style={{ paddingTop: 20 }}>
      ...
      <Box px={2} mb={1} ml={2} display="flex" gap={2}>
      ...
      <Grid container spacing={3} display="flex" justifyContent="space-evenly" marginBottom="2%" marginLeft="1%" ref={printRef}>
        {/* Submission Progress */}
