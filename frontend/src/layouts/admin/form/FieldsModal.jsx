    ...
    <div className="modal-backdrop">
      <div className="modal">
        <div className="modal-content">
          <h5>{isEditing ? 'Edit' : 'Add New'} {componentType} Label</h5>
          <form onSubmit={onSubmit}>
              ...
              <div>
                <div className="form-check form-check-inline">
                  <input
                    ...
                    id="requiredYes"
                    value="true"
                    checked={!!newLabel.required}
                    onChange={() => setNewLabel({ ...newLabel, required: true })}
                  />
                ...
                <div className="form-check form-check-inline">
                  <input
                    ...
                    value="false"
                    checked={!newLabel.required}
                    onChange={() => setNewLabel({ ...newLabel, required: false })}
                  />
            ...
            {/* Not Editable By section - updated to ensure proper state management */}
            {componentType !== 'instruction' && (
            <div className="form-group">
