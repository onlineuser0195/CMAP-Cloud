...
export const SystemDashboardPage = ({systemId: propSystemId}) => {
    ...
    <div>
      ...
      {(mappedRole == USER_ROLES.GLOBAL_ADMIN || mappedRole == USER_ROLES.LOCAL_ADMIN) &&  <><BackButton label="Global Dashboard" /><br/></>}
        ...
        <h2 className="text-center mb-4">
            ...
            {/* {userRole ? `${userRole} ` : 'System'} Dashboard */}
        </h2>
        <Tooltip
          placement="top-end"
          title={
        ...
        <h4>Forms List</h4>
        <FormsList systemId={systemId}/>
      </div>
      {/* {mappedRole !== USER_ROLES.GLOBAL_ADMIN && mappedRole !== USER_ROLES.LOCAL_ADMIN && <SystemDashboard systemId={systemId} />} */}
    </div>
  );
};
